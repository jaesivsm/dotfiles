...
" Delete whitespace at EOL when writing file
autocmd BufWritePre * %s/\s\+$//e
" Replace this "thing" : " " (not a fucking white space) by a true white space
...
" ============================================================
"
" Color SQL temp file when you edit a command with /e
autocmd BufRead /tmp/sql* set filetype=sql
" Mako/HTML
autocmd BufNewFile,BufRead *.mako,*.mak,*.jinja2 setlocal ft=html
autocmd FileType Javascript,html,xhtml,xml,css,yaml setlocal expandtab shiftwidth=2 tabstop=2 softtabstop=2
...
let g:syntastic_python_pep8_args = '--ignore=E126,E127,E128,E302,E402,E712,W503'
